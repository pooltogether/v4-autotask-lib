...
export async function drawBeaconHandleDrawStartAndComplete(contracts: ContractsBlob, config: BeaconChainConfig): Promise<PopulatedTransaction | undefined> {
  ...
  const drawBeacon = getContract('DrawBeacon', config.beaconChain.chainId, providerBeaconChain, contracts);
